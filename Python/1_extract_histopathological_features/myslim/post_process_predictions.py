...
def post_process_predictions(output_dir, slide_type, path_codebook, path_tissue_classes):
    """
    ...
    if slide_type == "FF":
        predictions_raw = pd.read_csv(
            output_dir + "/pred_train.txt", sep="\t", header=None)
        ...
        predictions.to_parquet(
            path=OUTPUT_PATH, compression='gzip', name_function=name_function)
...
if __name__ == "__main__":
    ...
    post_process_predictions(output_dir=args.output_dir, slide_type=args.slide_type, path_codebook=args.path_codebook,
