...
# Both changed to 1, because I downloaded only 2 images. However, in the end
# it should be 80% training and 20% validation.


#_NUM_CLASSES = 42
_NUM_CLASSES = 1        # Changed to 1, because we only do SKCM
