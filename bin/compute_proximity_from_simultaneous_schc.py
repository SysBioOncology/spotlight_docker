...
def get_args():
    ...
    parser.add_argument("--slide_clusters_characterized", type=str,
...
def compute_proximity_from_simultaneous_schc(slide_clusters_characterized, tiles_schc,
    ...
    all_slide_clusters_characterized = pd.read_csv(slide_clusters_characterized,
    ...
    results_schc_all = Parallel(n_jobs=n_cores)(delayed(features.compute_proximity_clusters_pairs)(
    ...
    # Post Processing
    results_schc_all = Parallel(n_jobs=n_cores)(delayed(features.post_processing_proximity)(
...
def main(args):
    compute_proximity_from_simultaneous_schc(
        ...
        overlap=args.overlap).to_csv(Path(args.output_dir, f"{args.prefix}_features_clust_all_schc_prox_wide.csv"), index = False)
