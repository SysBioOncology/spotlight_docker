...
def clustering_schc_individual(
        ...
        cell_types=None, graphs_path=None, n_cores = multiprocessing.cpu_count):
    ...
    slide_indiv_clusters = Parallel(n_jobs=n_cores)(delayed(clustering.schc_individual)(
    ...
    return all_slide_indiv_clusters, slide_indiv_clusters_labeled, all_slide_indiv_clusters_final, all_graphs


def main(args):
    all_slide_indiv_clusters, slide_indiv_clusters_labeled, all_slide_indiv_clusters_final,all_graphs = clustering_schc_individual(
    ...
    all_slide_indiv_clusters_final.to_csv(Path(args.output_dir, f"{args.prefix}_indiv_schc_tiles.csv"), index = False)

    slide_indiv_clusters_labeled.to_csv(
        Path(args.output_dir,f"{args.prefix}_indiv_schc_clusters_labeled.csv", index= False ))
